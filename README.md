...
- [歩行空間ナビ・データプラットフォーム「ほこナビDP」](https://www.hokonavi.go.jp/opendata/) (国土交通省) - 歩行空間ネットワークデータ (歩道データ等) や関連データ
- [歩行者移動支援サービスに関するデータサイト (バリアフリー・ナビプロジェクト)](https://www.hokoukukan.go.jp/top.html) (国土交通省) [最終更新: 2022年]

##### 航空・宇宙

- [CARATS Open Data](https://www.mlit.go.jp/koku/carats/#copen) (国土交通省・要申請) - 定期航空便の時刻・位置等の航跡データ
...
- [エネマネオープンデータ](https://www.ems-opendata.jp/) (一般社団法人環境共創イニシアチブ・要登録) - 事業所の電力消費実績データ、エネルギー使用実績データ等

### 政府・国

- [落札実績オープンデータ](https://www.p-portal.go.jp/pps-web-biz/UAB02/OAB0201) (デジタル庁) - 政府電子調達システムでの落札実績データ
...
- [静岡県オープンデータ (ふじのくに オープンデータカタログ)](https://opendata.pref.shizuoka.jp/)
...
- [zurekei（ズレ計）](https://zurekei.org/) - 政府・公的機関の経済見通しと実績を、公表のたび記録・照合する個人運営の計器サイト
